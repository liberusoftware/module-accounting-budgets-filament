...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-accounting-budgets-filament?sort=semver)](https://github.com/liberusoftware/module-accounting-budgets-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-accounting-budgets-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-accounting-budgets-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-accounting-budgets-filament
```
...
<a href="https://github.com/liberusoftware/module-accounting-budgets-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-accounting-budgets-filament" alt="Contributors to liberusoftware/module-accounting-budgets-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-accounting-budgets-filament/graphs/contributors).
